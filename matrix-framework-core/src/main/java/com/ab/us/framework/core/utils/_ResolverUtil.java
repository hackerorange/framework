...
import com.ab.us.framework.core.utils.support.VFS;
...
class _ResolverUtil<T> {
	/*
	 * An instance of Log to use for logging in this class.
	 */
	private static final Log log = LogFactory.getLog(_ResolverUtil.class);
	 ...
	 *            classes
	 */
	public _ResolverUtil<T> findImplementations(Class<?> parent,
			String... packageNames) {
	 ...
	 *            classes
	 */
	public _ResolverUtil<T> findAnnotated(
	 ...
	 */
	public _ResolverUtil<T> find(Test test, String packageName) {
	...
	protected void addIfMatching(Test test, String fqn) {
		try {
			...
			log.debug("Checking to see if class " + externalName
