...
public abstract class VFS {
	...
	protected static Method getMethod(Class<?> clazz, String methodName,
		...
		try {
			...
			log.error("Security exception looking for method "
					+ clazz.getName() + "." + methodName + ".  Cause: " + e);
			return null;
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected static <T> T invoke(Method method, Object object,
			Object... parameters) throws IOException, RuntimeException {
		try {
